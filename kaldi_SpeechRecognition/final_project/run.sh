...
rm -r ~/share/wav_data/result
mkdir -p ~/share/wav_data/result/mono
mkdir -p ~/share/wav_data/result/tri1
...
for x in mono tri1; do cp exp/$x/decode_test/log/decode.*.log ~/share/wav_data/result/$x/ ; done
